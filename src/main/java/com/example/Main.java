    ...
    public static void main(String[] args) throws UnknownHostException, IOException {
        try {
            ...
            do {
                ...
                if (elementiComando[0].equals("LOGIN") && statoLogin == false) {
                    ...
                    statoLogin = true;
                } else if (elementiComando[0].equals("USERS") && statoLogin == true) {
                    out.writeBytes(comando);
                ...
                } else if (elementiComando[0].equals("MSG") && statoLogin == true) {
                    out.writeBytes(comando);
                    esito = in.readLine();
